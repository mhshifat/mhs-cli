        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, generateNodeRestBoilerplate({
                            asDev: asDev,
                ...
                case 2:
                    _b.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, generateNodeRestTsBoilerplate({
                        asDev: asDev,
                        packageManager: packageManager,
                        folderName: folderName,
                        packageManagerShellCmd: packageManagerShellCmd,
...
function generateNodeRestBoilerplate(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    source = path_1.default.join(__dirname, "..", "..", "examples", "node-api");
                    return [4 /*yield*/, fs_extra_1.default.copy(source, destination)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, index_1.execShellCommand("cd " + folderName + " && " + packageManagerShellCmd + " cors dotenv esm express helmet morgan")];
                case 2:
                    _b.sent();
...
function generateNodeRestTsBoilerplate(_a) {
    var folderName = _a.folderName, packageManagerShellCmd = _a.packageManagerShellCmd, destination = _a.destination, projectName = _a.projectName, spinner = _a.spinner, asDev = _a.asDev, packageManager = _a.packageManager;
    return __awaiter(this, void 0, void 0, function () {
        var source;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    source = path_1.default.join(__dirname, "..", "..", "examples", "node-api-ts");
                    return [4 /*yield*/, fs_extra_1.default.copy(source, destination)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, index_1.execShellCommand("cd " + folderName + " && " + packageManagerShellCmd + " cors dotenv express helmet morgan")];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, index_1.execShellCommand("cd " + folderName + " && " + packageManagerShellCmd + " " + asDev + " @types/cors @types/express @types/node @typescript-eslint/eslint-plugin @typescript-eslint/parser eslint eslint-config-standard eslint-plugin-import eslint-plugin-node eslint-plugin-promise nodemon ts-node typescript")];
                case 3:
                    _b.sent();
                    return [4 /*yield*/, index_1.execShellCommand("cd " + folderName + " && " + packageManager + " install")];
                case 4:
