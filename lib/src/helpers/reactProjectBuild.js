        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, generateReactBoilerplate({
                ...
                case 2:
                    _b.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, generateReactTSBoilerplate({
                        folderName: folderName,
                        packageManagerShellCmd: packageManagerShellCmd,
                        destination: destination,
                        projectName: projectName,
...
function generateReactBoilerplate(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    source = path_1.default.join(__dirname, "..", "..", "examples", "react");
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, index_1.execShellCommand("cd " + folderName + " && " + packageManagerShellCmd + " react-router-dom")];
                case 4:
                    _b.sent();
...
function generateReactTSBoilerplate(_a) {
    var folderName = _a.folderName, packageManagerShellCmd = _a.packageManagerShellCmd, destination = _a.destination, projectName = _a.projectName, spinner = _a.spinner;
    return __awaiter(this, void 0, void 0, function () {
        var source;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    source = path_1.default.join(__dirname, "..", "..", "examples", "react-ts");
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, index_1.execShellCommand("cd " + folderName + " && " + packageManagerShellCmd + " react-router-dom @types/react-router-dom")];
                case 4:
                    _b.sent();
                    return [4 /*yield*/, fs_extra_1.default.copy(source, destination)];
                case 5:
